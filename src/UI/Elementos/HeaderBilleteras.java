...
public class HeaderBilleteras extends javax.swing.JPanel {
    ...
    private void tROutlineButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tROutlineButton1ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Desea crear una nueva billetera?") == 0) {
            Billetera newBilletera = a.createNewBilletera();
